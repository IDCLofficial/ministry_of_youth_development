...
export const Hero = () => {
    return(
        <div className="relative h-[85vh] px-[3rem] w-screen flex flex-col justify-center bg-[url('/images/heroImage.png')] bg-cover bg-center">
            ...
            <div className="relative z-10 py-10">
                <div className="w-[60%] flex flex-col gap-4">
                    ...
                    <h1 className="text-[2.5rem] font-bold text-white">Transparent Governance. Accountable Finance. Sustainable Growth.</h1>
