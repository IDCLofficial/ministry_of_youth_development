...
export const Navbar = ({ onOpenSidebar }: NavbarProps) => {
    return(
        <header className="flex justify-between items-center px-[1rem] md:px-[2rem] py-[1.5rem] fixed top-0 left-0 right-0 z-50 border-b border-b-[0.1px] border-[#FFFFFF] bg-[#232c39]/50 backdrop-blur-sm">
