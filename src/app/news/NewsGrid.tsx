  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
      {newsList.map((item, idx) => (
        <Link 
          href={`/news/1`}
          key={idx} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-5 flex-1 flex flex-col">
            ...
            <p className="text-dark-primary-body mb-4 line-clamp-2">{item.desc}</p>
